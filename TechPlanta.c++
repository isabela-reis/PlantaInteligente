...
umidadeSolo = analogRead(pinoSensorAgua);
...
alarme();
 ...
 }else if(umidadeSolo > 40 && umidadeSolo<85) {
digitalWrite (ledVerde,HIGH);

lcd.setCursor(0, 1);

lcd.print(" Tudo bem :D ");
delay(3000);
